...
#define FIBER_SEND_END_ADDR               0xDBFFF
...
#define FIBER_RECV_END_ADDR_A              0xD5032   /*A读取数据终止位置*/
#define FIBER_RECV_TOTAL_MEMORY_SIZE_A    (FIBER_RECV_END_ADDR_A - FIBER_RECV_START_ADDR_A)

#define FIBER_RECV_START_ADDR_B           0xD5035      /*B读取数据起始位置*/
#define FIBER_RECV_END_ADDR_B             0xDA032    /*B读取数据终止位置*/
